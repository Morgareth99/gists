...
def send_page_msg(line=1,page='A',lead=None,disp='A',wait=5,lag=None,msg='') :
	...
	# DIM GREEN: return '<L%d><P%c><F%c><M%c><W%c><F%c><CD>'%(
...
if __name__ == '__main__' :
	...
	if opts.message :
		...
		data = send_page_msg(msg=msg, page=opts.page, line=opts.line, lead=opts.lead, lag=opts.lag, disp=opts.disp, wait=opts.wait)
